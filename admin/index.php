            ...
            <div class="bar-box">
                <aside class="left-bar">
                    <div class="admin-box">
                        ...
                        echo "<img class=\"userPic\" src=\"" . substr($_SESSION['admin_pic'], 3, strlen($_SESSION['admin_pic'])) . "?" . mt_rand(10000, 99999) . "\" /><h4 class=\"online-user\">" . $_SESSION['admin_name'] . "</h4><i class=\"iconfont icon-certificated\" style=\"color: #1afa29;\"></i><h5 class=\"user-type\">" . $admin_type . "</h5>";
                        ?>
                    </div>
                ...
                <div class="main-bar">
                    <script>
                        $(document).ready(() => {
                            if (getUserInfo().admin_type == 1 || getUserInfo().admin_type == 2) {
                                $.pjax({
                                    url: "employeeList",
                                    container: '.main-bar'
                                });
                            } else {
                                window.wxc.xcConfirm("你没有权限", window.wxc.xcConfirm.typeEnum.error, {
                                    onOk: function() {

                            ...
                            <div class="inner-box">
                                <table class="employeeListTable" style="display: none;">
                                    ...
                                    <tbody class="employeeListTableBody">
                                        <?php
                                        $sql_query = "SELECT EMPLOYEE_ID,NAME,GENDER,WORKING_YEAR,AGE,SALARY,PHONE_NUM,EMPLOYEE_TYPE,EMPLOY_TIME FROM SCOTT.empRead WHERE EMP_STATUS>0 ORDER BY EMPLOYEE_TYPE ASC,EMPLOY_TIME DESC,WORKING_YEAR DESC";
